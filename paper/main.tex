...
\midrule
Cross-domain probe top-1 & 90.0\% & 0.0\% \\
Cross-domain probe top-10 & 95.0\% & 3.3\% \\
Fair evaluation top-1 & 90.0\% & 0.0\% \\
Fair evaluation top-10 & 95.0\% & 3.3\% \\
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Cross-domain:} 100\% top-1, 100\% top-10 transfer accuracy (20 probes, word-level tokenization, seed 42).
