"""
Phase 4 — Option 3: Conservative 32-dim baseline triplet-margin trajectory.
...
- Logs trajectory to trajectory_option3_baseline.json
"""
...
def run(
    ...
    out_path = os.path.join(SCRIPT_DIR, "experiment_results", "trajectory_option3_baseline.json")
...
if __name__ == "__main__":
    ...
    # Run the model with 32-dim latent (which is set in init_model and RLMv2 initialization via constants)
    run(
        epochs=args.epochs,
        margin=args.margin,
        seed=args.seed,
