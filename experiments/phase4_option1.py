"""
Phase 4 — Option 1: in-domain triplet-margin trajectory.

Validation triples use ONLY words that appear in the training set.
This tests whether triplet margin learns analogical structure for
vocabulary the encoder actually sees, without the OOV confounding factor.

Expected behavior vs stale baseline:
  - Healthy gap trajectory (0.2-0.5) for at least some validation triples
  - loss == 0 after a few epochs means margin is satisfied
  - cross-domain transfer should improve
"""
...
# ──────────────────────────────────────────────────────────────────────────
# Training triples (in-domain words only)
# ──────────────────────────────────────────────────────────────────────────
...
def run(
    ...
    out_path = os.path.join(SCRIPT_DIR, "experiment_results", "trajectory_option1.json")
