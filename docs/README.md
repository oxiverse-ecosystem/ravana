...
graph walks; cognition is orchestrated by a 27-phase "GRACE" governor.
...
| File | What it covers |
|------|----------------|
| [ARCHITECTURE.md](ARCHITECTURE.md) | End-to-end data flow: input → brain-repair → graph → decoder → response. The three packages and how they fit together. |
