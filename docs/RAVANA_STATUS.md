...
### Remaining
1. **~~Cross-domain transfer at 0.0~~** → **LARGELY RESOLVED (2026-05-24).** Relation predictor achieves 14.3% top-1. **Sleep-time replay achieves +42.9pp Domain A retention.** Catastrophic forgetting bottleneck solved. Target 25%+ top-1 cross-domain.
