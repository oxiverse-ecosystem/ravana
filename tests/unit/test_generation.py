...
def test_instruction_compression():
    ...
    generated = model.generate(
        ...
        trace_md_path="output/compression_trace.md"
    )
    print(f"Generated: '{generated}'")

    assert os.path.exists("output/compression_trace.json"), "JSON trace not written"
    assert os.path.exists("output/compression_trace.md"), "MD trace not written"
    import json
    with open("output/compression_trace.json", "r", encoding="utf-8") as f:
