...
def test_self_profile_renders_since_age_naturally(tmpdir):
    ...
    assert "since you were about" in reply or "started" in reply or "when you were" in reply, f"not rendered naturally: {reply!r}"
...
def test_self_profile_renders_since_year_naturally(tmpdir):
    ...
    assert "started" in reply or "since" in reply or "started in" in reply, f"not rendered naturally: {reply!r}"
