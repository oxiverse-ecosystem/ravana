...
def test_consolidation():
    """Exp 4: Sleep cycle produces measurable consolidation."""
    ...
    # Consolidation = either structural changes OR significant energy reduction
    assert has_change or energy_drop > 3.0, (
        f"Expected consolidation: structural changes={results['structural_changes']}, "
        f"energy drop={energy_drop:.1f}%"
    )
