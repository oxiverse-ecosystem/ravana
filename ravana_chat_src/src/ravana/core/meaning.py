...
class MeaningEngine:
    ...
    @property
    def accumulated_meaning(self) -> float:
        """Access accumulated meaning from state."""
        return self.state.accumulated_meaning

    @accumulated_meaning.setter
    def accumulated_meaning(self, value: float):
        self.state.accumulated_meaning = value